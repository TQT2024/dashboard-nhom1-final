...
def render_tab_general():
    ...
    if df_filtered.empty:
        st.warning("Không có dữ liệu phù hợp với tiêu chí bộ lọc đã chọn. Vui lòng chọn lại!")
        return
    ...
    with c1:
        ...
        fig_bar = px.bar(
            df_gender_gpa, y="gender_label", x="Số lượng", color="Học lực", orientation="h",
            text_auto='.1f', category_orders={"Học lực": gpa_order},
            color_discrete_sequence=px.colors.sequential.Blues_r,
            labels={"gender_label": "Giới tính", "Số lượng": "Tỷ trọng (%)"}
        )
        fig_bar.update_layout(barmode='stack', barnorm='percent', xaxis_title="Tỷ lệ phần trăm (%)", yaxis_title=None, margin=dict(l=0, r=0, t=30, b=0))
    ...
    with c2:
        ...
        fig_heat = px.density_heatmap(
            df_filtered, x="Thời gian tự học", y="Học lực", 
